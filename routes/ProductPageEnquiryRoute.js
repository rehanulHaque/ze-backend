import {ProductPageEnquirySchema} from "../models/ProductPageEnquiryModel.js"
...
router.post("/", async (req, res) => {
    try {
        ...
        const newEnquiry = await ProductPageEnquirySchema.create(req.body);
...
router.get("/", async (req, res) => {
    try {
        await connectToDB();
        const data = await ProductPageEnquirySchema.find()
