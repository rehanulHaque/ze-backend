import {ServiceQuickEnquiry} from "../models/ServiceQuickEnquiryModel.js"
...
router.post("/", async (req, res) => {
    try {
        ...
        const newEnquiry = await ServiceQuickEnquiry.create(req.body);
...
router.get("/", async (req, res) => {
    try {
        await connectToDB();
        const data = await ServiceQuickEnquiry.find()
